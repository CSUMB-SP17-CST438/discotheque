...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>
{
	...
	private boolean mayRequestContacts()
	{
		...
		{
			Snackbar.make(mEmailView, R.string.register_activity_permission_rationale, Snackbar.LENGTH_INDEFINITE)
	...
	private void attemptLogin()
	{
		...
		{
			mEmailView.setError(getString(R.string.register_activity_error_field_required));
